...
namespace SmolenskTravelRESTFullAPI.Controllers.Tours
{
    ...
    public class ToursController : ControllerBase
    {
        ...
        public ToursController(SmolenskTravelContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Tour>> PostTour(Tour tour)
        {
          if (_context.Tours == null)
          {
              return Problem("Entity set 'SmolenskTravelContext.Tours'  is null.");
          }
